...
export function SplineSceneBasic() {
    ...
    return (
        <div className="w-full min-h-screen bg-[#0d1117] relative overflow-x-hidden overflow-y-auto flex flex-col">
                ...
                {showGenerator === 'none' ? (
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-20">
                            ...
                            >
                                <div className="p-4 rounded-lg bg-[#161b22]/50 border border-[#30363d] text-center hover:border-[#58a6ff] transition-colors group">
                                    <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-[#238636]/20 flex items-center justify-center group-hover:bg-[#238636]/30 transition-colors">
                                        <Code2 className="w-5 h-5 text-[#3fb950]" />
                                    </div>
                                    <h4 className="text-white font-medium text-sm">Instant Preview</h4>
                                    <p className="text-[#8b949e] text-xs mt-1">See changes in real-time</p>
                                </div>
                                <div className="p-4 rounded-lg bg-[#161b22]/50 border border-[#30363d] text-center hover:border-[#58a6ff] transition-colors group">
                                    <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-[#a371f7]/20 flex items-center justify-center group-hover:bg-[#a371f7]/30 transition-colors">
                                        <Sparkles className="w-5 h-5 text-[#a371f7]" />
                                    </div>
                                    <h4 className="text-white font-medium text-sm">AI Powered</h4>
                                    <p className="text-[#8b949e] text-xs mt-1">Smart content generation</p>
                                </div>
                                <div className="p-4 rounded-lg bg-[#161b22]/50 border border-[#30363d] text-center hover:border-[#58a6ff] transition-colors group">
                                    <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-[#58a6ff]/20 flex items-center justify-center group-hover:bg-[#58a6ff]/30 transition-colors">
                                        <FileText className="w-5 h-5 text-[#58a6ff]" />
                                    </div>
                                    <h4 className="text-white font-medium text-sm">Beautiful Design</h4>
                                    <p className="text-[#8b949e] text-xs mt-1">Professional templates</p>
                                </div>
                                <div className="p-4 rounded-lg bg-[#161b22]/50 border border-[#30363d] text-center hover:border-[#58a6ff] transition-colors group">
                                    <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-[#f0883e]/20 flex items-center justify-center group-hover:bg-[#f0883e]/30 transition-colors">
                                        <Package className="w-5 h-5 text-[#f0883e]" />
                                    </div>
